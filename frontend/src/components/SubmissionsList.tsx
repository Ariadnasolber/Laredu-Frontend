...
export default function SubmissionsList() {
    ...
    return (
        <div className="mt-4 flex items-center justify-center flex-col">
            <h2 className="text-2xl font-bold mb-2 underline underline-offset-8 decoration-orange-500 mb-8">Entregas de Tareas</h2>
            {message && <p className="text-green-500">{message}</p>}
            <form onSubmit={handleSubmit} className="mb-4 flex space-x2 gap-2">
                <input
                    type="number"
                ...
                <button
                    type="submit"
                    className="bg-orange-500 text-white p-2 rounded w-28"
                >
                    Entregar
                </button>
            </form>
