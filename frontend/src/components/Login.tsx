...
export default function Login({ onLoginSuccess }: LoginProps) {
    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center align-center bg-zinc-900">
            <div className="bg-white h-90 px-10 rounded shadow w-100 flex align-center justify-center flex-col">
                <h2 className="text-xl flex justify-center font-bold mb-10">LOGIN</h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col space-y-3">
                    ...
                    <p className="flex justify-center">Don't have an account? <a className="ml-3 underline decoration-pink-500" href="/Register"> Register</a></p>
                </form>
            </div>
        </div>
    );
